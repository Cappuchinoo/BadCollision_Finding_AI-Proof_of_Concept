...
class BugPlatformEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # Misc
        self.speed_factor = 0.17  # The higher the value, higher the reward for reaching the flag quickly
        ...
        self.bug_gap_y_max = self.bug_gap_y_min + (self.hitbox_height * 6)  # "HARD" to find bug
    ...
    def step(self, action):
        ...
        # When to the right of the wall, move right
        if x_new > self.wall_x and dist_curr < dist_prev:
            reward += 0.08
        ...
        if self._reached_flag(x_new, y_new):
            ...
            reward += 40.0 + (self.speed_factor * time_left)
            terminated = True
